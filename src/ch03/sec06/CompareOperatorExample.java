...
public class CompareOperatorExample {
	...
	public static void main(String[] args) {
		...
		int num3 = 1;
		double num4 = 1.0;
		boolean result5 = (num3 == num4); //1 == 1.0 
		...
		String str1 = "자바";
		String str2 = "Java";
		boolean result8 = (str1.equals(str2)); //문자열 비교할 때에는 equals(), !equals() 사용
		boolean result9 = (! str1.equals(str2)); //문자열이 같은지, 다른지 검사 가능(대소문자 구분)
